...
void MyDB_Schema ::addAtt(string tableName,
                          pair<string, MyDB_AttTypePtr> attToAdd,
    ...
    catalog->putString(tableName + "." + attToAdd.first + ".type",
                       attToAdd.second->toString());
}
