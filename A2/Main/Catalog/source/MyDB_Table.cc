...
MyDB_Table ::MyDB_Table(string name, string storageLocIn,
                        MyDB_SchemaPtr mySchemaIn, string fileTypeIn,
                        string sortAttIn) {
    tableName = name;
    storageLoc = storageLocIn;
    mySchema = mySchemaIn;
...
string &MyDB_Table ::getName() { return tableName; }
...
size_t MyDB_Table ::getDistinctValues(int forMe) { return allCounts[forMe]; }

void MyDB_Table ::setDistinctValues(vector<size_t> &toMe) { allCounts = toMe; }

void MyDB_Table ::setTupleCount(size_t toMe) { count = toMe; }

size_t MyDB_Table ::getTupleCount() { return count; }

void MyDB_Table ::setRootLocation(int toMe) { rootLocation = toMe; }

int MyDB_Table ::getRootLocation() { return rootLocation; }

string &MyDB_Table ::getFileType() { return fileType; }

string &MyDB_Table ::getSortAtt() { return sortAtt; }

string &MyDB_Table ::getStorageLoc() { return storageLoc; }
...
int MyDB_Table ::lastPage() { return last; }

void MyDB_Table ::setLastPage(size_t toMe) { last = (int)toMe; }

// from this function we know that catalog stores metadata of tables
...
MyDB_SchemaPtr MyDB_Table ::getSchema() { return mySchema; }

std::ostream &operator<<(std::ostream &os, const MyDB_Table printMe) {
    os << "name: " << printMe.tableName << "; file: " << printMe.storageLoc
       << "; schema: " << printMe.mySchema;
    return os;
}
...
std::ostream &operator<<(std::ostream &os, const MyDB_TablePtr printMe) {
    if (printMe == nullptr) {
        ...
        os << "name: " << printMe->tableName
           << "; file: " << printMe->storageLoc
           << "; schema: " << printMe->mySchema;
    }
    return os;
}
