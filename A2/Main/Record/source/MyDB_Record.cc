...
pair<func, MyDB_AttTypePtr> MyDB_Record ::compileHelper(char *&vals) {
    ...
    while (true) {
        ...
        if (vals[0] == '!' && vals[1] == '=') {
            ...
            // can be optmized by return if the lres is true?
        ...
        //     return neq(lres, rres);
            ...
            return make_pair([temp] { return temp; },
...
pair<func, MyDB_AttTypePtr> MyDB_Record ::fromData(string attName) {
    ...
    return make_pair([this, whichAtt] { return values[whichAtt.first]; },
                     whichAtt.second);
}

pair<func, MyDB_AttTypePtr>
MyDB_Record ::plus(pair<func, MyDB_AttTypePtr> lhs,
                   pair<func, MyDB_AttTypePtr> rhs) {
    ...
    if (lhs.second->promotableToInt() && rhs.second->promotableToInt()) {
        ...
        // otherwise, if both sides can be cast upwards to be doubles, then do
        // so
    } else if (lhs.second->promotableToDouble() &&
               rhs.second->promotableToDouble()) {
        MyDB_DoubleAttValPtr temp = make_shared<MyDB_DoubleAttVal>();
        scratch.push_back(temp);
        ...
        // otherwise, if both sides can be cast upwards to be strings, then do
        // so
    } else if (lhs.second->promotableToString() &&
               rhs.second->promotableToString()) {
        MyDB_StringAttValPtr temp = make_shared<MyDB_StringAttVal>();
        scratch.push_back(temp);
...
pair<func, MyDB_AttTypePtr>
MyDB_Record ::minus(pair<func, MyDB_AttTypePtr> lhs,
                    pair<func, MyDB_AttTypePtr> rhs) {
...
pair<func, MyDB_AttTypePtr>
MyDB_Record ::unaryMinus(pair<func, MyDB_AttTypePtr> lhs) {
...
pair<func, MyDB_AttTypePtr>
MyDB_Record ::times(pair<func, MyDB_AttTypePtr> lhs,
                    pair<func, MyDB_AttTypePtr> rhs) {
...
pair<func, MyDB_AttTypePtr>
MyDB_Record ::divide(pair<func, MyDB_AttTypePtr> lhs,
                     pair<func, MyDB_AttTypePtr> rhs) {
...
pair<func, MyDB_AttTypePtr> MyDB_Record ::gt(pair<func, MyDB_AttTypePtr> lhs,
                                             pair<func, MyDB_AttTypePtr> rhs) {
...
pair<func, MyDB_AttTypePtr> MyDB_Record ::lt(pair<func, MyDB_AttTypePtr> lhs,
                                             pair<func, MyDB_AttTypePtr> rhs) {
...
pair<func, MyDB_AttTypePtr> MyDB_Record ::eq(pair<func, MyDB_AttTypePtr> lhs,
                                             pair<func, MyDB_AttTypePtr> rhs) {
...
pair<func, MyDB_AttTypePtr> MyDB_Record ::neq(pair<func, MyDB_AttTypePtr> lhs,
                                              pair<func, MyDB_AttTypePtr> rhs) {
...
pair<func, MyDB_AttTypePtr> MyDB_Record ::orr(pair<func, MyDB_AttTypePtr> lhs,
                                              pair<func, MyDB_AttTypePtr> rhs) {
...
pair<func, MyDB_AttTypePtr>
MyDB_Record ::andd(pair<func, MyDB_AttTypePtr> lhs,
                   pair<func, MyDB_AttTypePtr> rhs) {
...
pair<func, MyDB_AttTypePtr>
MyDB_Record ::nott(pair<func, MyDB_AttTypePtr> lhs) {
...
void MyDB_Record ::recordContentHasChanged() { bufferOld = true; }
...
void MyDB_Record ::fromString(string res) {
    int i = 0;
    for (int pos = 0; pos < (int)res.size();
         pos = (int)res.find("|", pos + 1) + 1) {
...
function<bool()> buildRecordComparator(MyDB_RecordPtr lhs, MyDB_RecordPtr rhs,
                                       string computation) {
...
MyDB_SchemaPtr &MyDB_Record ::getSchema() { return mySchema; }

MyDB_AttValPtr &MyDB_Record ::getAtt(int whichAtt) { return values[whichAtt]; }
...
MyDB_Record ::~MyDB_Record() { delete[] buffer; }
