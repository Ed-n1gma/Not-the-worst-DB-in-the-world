...
public:
	...
	// for the merge of two different tables
	friend function <bool ()> buildRecordComparator (MyDB_RecordPtr lhs,  MyDB_RecordPtr rhs, const string& leftComp, const string& rightComp);
